...
if __name__ == "__main__":
    ...
    for TIME_STR in TIME_STRs:
        ...
        u_pred = model_config.forward(x_valid)
        W = model_config.detach(model_config.W)
        # print('W_R ' + str(W_R))
        ...
        file_name = root_path + '/' + TASK_NAME + '/' + TIME_STR + '/Poisson1D'
        file_name1 = root_path + '/' + TASK_NAME + '/' + TIME_STR + '/error_Poisson1D'
        datas1 = []
        datas2 = []
        data_labels1 = []
        data_labels2 = []
        data_labels1.append('$u_{exact}$')
        data_labels1.append('$u_{M}$')
