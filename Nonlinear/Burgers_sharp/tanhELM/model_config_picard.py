    ...
    def optimize_one_epoch(self):
        ...
        with torch.no_grad():        
            ...
            for k in range(100):
                ...
                # uk_x = self.reload(self.compute_grad(uk, x), requires_grad=False)
                # uk_y = self.reload(self.compute_grad(uk, y), requires_grad=False)
                # uk = self.reload(uk, requires_grad=False)
