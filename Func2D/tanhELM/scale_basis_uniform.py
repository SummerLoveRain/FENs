...
print(f"Working directory is now: {os.getcwd()}")
current_dir = os.path.dirname('/home/lunxu/yangqh/FEN/Func2D/tanhELM/')
set_dir(current_dir)
...
data_labels =[]
data_labels.append('$e_{L_{\infty}}$ of M=400')
data_labels.append('$e_{L_{\infty}}$ of M=900')
data_labels.append('$e_{L_{\infty}}$ of M=1600')
data_labels.append('$e_{L_{\infty}}$ of M=2500')
